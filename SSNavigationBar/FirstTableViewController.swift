...
class FirstTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationController!.navigationBar.SS_setBarBackgroundColor(UIColor.orangeColor().colorWithAlphaComponent(0))
    ...
    override func scrollViewDidScroll(scrollView: UIScrollView) {
        ...
        let barAlpha = Tool.SS_NowBetweenAB(0, B: 300 - 64, NOW: contentOffsetY)
        self.navigationController!.navigationBar.SS_setBarBackgroundColor(UIColor.orangeColor().colorWithAlphaComponent(barAlpha))
